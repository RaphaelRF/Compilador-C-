...
{ fprintf(listing,"Erro na linha %d: %s.\n",t->lineno,message);
  Error = TRUE;
}
...
{ traverse(syntaxTree,nullProc,checkNode);
  if(st_main_decl() == 0)
  { fprintf(listing,"Erro: main nao declarada\n");
    Error = TRUE;
  }
